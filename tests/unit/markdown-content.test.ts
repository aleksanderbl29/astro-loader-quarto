...
import { readRenderedMarkdown, matchQmdToMd, resolveContentPaths, checkRenderedFileExists } from '../../src/parsers/markdown-content.js';
...
describe('markdown-content', () => {
  ...
  describe('matchQmdToMd', () => {
    ...
    it('should handle nested directories', () => {
      ...
      expect(result).toBe(join(quartoRoot, outputDir, 'posts', '2024', 'my-post.md'));
    });
  ...
  describe('resolveContentPaths', () => {
    it('should return both qmd and md paths', () => {
      ...
      expect(result.mdPath).toBe(join(quartoRoot, outputDir, 'posts', 'my-post.md'));
    });
  });
  ...
  describe('checkRenderedFileExists', () => {
    it('should return true if rendered file exists', async () => {
      ...
      const result = await checkRenderedFileExists(qmdPath, quartoRoot, outputDir);
