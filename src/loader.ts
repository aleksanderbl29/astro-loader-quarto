...
import { parseQuartoYaml, extractListings, getOutputDir, findListing } from './parsers/quarto-yaml.js';
        ...
        for (const listing of listingsToLoad) {
          ...
          for (const entry of sortedEntries) {
            try {
              ...
              logger.error(`Validation failed for ${entry.id}: ${(error as Error).message}`);
